      ...
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onClick={() => navigate(isDeveloper ? "/developer/projects/new" : "/auth?role=developer")} className="bg-primary-foreground text-primary px-8 py-3.5 rounded-xl font-medium hover:opacity-90 transition-opacity w-full sm:w-auto">
              {t("cta.publishBtn")}
            </button>
